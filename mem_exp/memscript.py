...
t2 = tt()
print(f"kmeans++ with {args.nthreads} threads, k = {args.k} in {t1 - t2}s", file=sys.stdout)
...
t2 = tt()
print(f"mbkmeans with {args.nthreads} threads, k = {args.k} in {t1 - t2}s", file=sys.stdout)
